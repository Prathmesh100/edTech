...
const LearningGrid = () => {
  return (
    <div className='grid mx-auto lg:grid-cols-4  lg:grid-rows-2 grid-cols-1  w-11/12 max-w-maxContent mb-20'>
        {
            LearningGridArry.map((card,index)=>{
                return(
                    <div 
                    key={index}
                    ...
                    ${
                    ...
                    } `}>
                        {
                            ...
                            (<div className='bg-richblack-900 text-richblack-5 ' >
                                <div className='text-4xl font-semibold leading-10 flex flex-col '>
                                    {card.heading}
                                    <HighlightText text={card.highlightText}/>
                                </div>
                                <p className='text-richblack-200 mt-4 w-[80%]'>{card.description}</p>
                            ...
                            (
                                <div className='flex flex-col p-8   '>
                                    ...
                                    <p className='mt-8 text-richblack-200'>{card.description}</p>
                                </div>
                            )
                        }
